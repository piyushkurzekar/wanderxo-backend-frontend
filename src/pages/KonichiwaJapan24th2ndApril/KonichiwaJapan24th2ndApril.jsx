...
import './KonichiwaJapan24th2ndApril.css';
import japanImage from "../../assets/images/japan_day1.jpg";
import japanImage2 from "../../assets/images/japan_day2.jpg";
import japanImage3 from "../../assets/images/japan_day3.jpg";
import japanImage4 from "../../assets/images/japan_day4.jpg";
import japanImage5 from "../../assets/images/japan_day5.jpg";
import japanImage6 from "../../assets/images/japan_day6.jpg";
import japanImage7 from "../../assets/images/japan_day7.jpg";
import japanImage8 from "../../assets/images/japan_day8.jpg";
import japanImage9 from "../../assets/images/japan_day9.jpg";
import japanImage10 from "../../assets/images/japan_day10.jpg";
import japanImage11 from "../../assets/images/japanslideshow1.jpg";
import japanImage12 from "../../assets/images/japanslideshow2.jpg";
import japanImage13 from "../../assets/images/japanslideshow3.jpg";
import japanImage14 from "../../assets/images/japanslideshow4.jpg";
import japanImage15 from "../../assets/images/japansneakpeek1.jpg";
import japanImage16 from "../../assets/images/japansneakpeek2.jpg";
import japanImage17 from "../../assets/images/japansneakpeek3.jpg";
import japanImage18 from "../../assets/images/japansneakpeek4.jpg";
import japanImage19 from "../../assets/images/japansneakpeek5.jpg";
...
Lake Ashi Cruise Sail across a serene lake with Mt. Fuji in the backdrop and traditional torii gates on the shore — pure peace and perfect photos.`,
            ...
            desc: "Spend the day your way with two unforgettable experiences: race through the neon" +
                " streets of Tokyo in real go-karts dressed as your favourite Mario characters (v" +
                "alid licence + IDP required), or immerse yourself in the world’s only Tokyo Disn" +
                "eySea, a cinematic, adult-friendly Disney park with seven themed ports and iconi" +
                "c attractions like Journey to the Center of the Earth, Tower of Terror, and Soar" +
                "ing.Please note: transfers are not included for this day, as the group will be s" +
                "plit between the two experiences and final numbers are yet to be confirmed. Pick" +
                " the vibe that suits you best! Download the Disney app before entering to check " +
                "wait times!",
...
• Or hop over to Osaka to explore Shinsaibashi shopping street, Kuromon Market, or chill in a high - rise café in Umeda Sky Building.This is your "choose your own adventure" day — go wild or go slow!`,
            ...
            day: 9,
            title: "Day 9:Osaka Highlights – Castles, Cup Noodles & City Vibes Cup Noodles Museum (I" +
                "keda)",
...
​`,
            ...
            desc: "Group airport transfers to Kansai International (Itami) or Haneda for your fligh" +
                "t home. Safe travels!",
    ...
    inclusions: [
        ...
        "Osaka highlights: Cup Noodle Museum, Dotonbori, HEP Five Ferris Wheel, Osaka Cas" +
        "tle",
    ...
    sneakPeek: [
        japanImage15, japanImage16, japanImage17, japanImage18
    ],
    heroSlides: [
        {
            image: japanImage11,
            ...
            // subtitle: "Immerse yourself in the neon-lit streets and cutting-edge culture of Japan's cap" +
            //         "ital"
        },
        {
            image: japanImage14,
        ...
        <div id="hero" className="hero-section">
            ...
            <div className="hero-overlay">
                ...
                <div className="hero-buttons">
                    <a href="https://buy.stripe.com/bJe28q0CF9CzbBg5vwcs81W" className="btn btn-primary">Reserve your spot</a>
...
function Pricing() {
    return (
        <section className="pricing-section">
            <h1 style={{ textAlign: "center", marginBottom: "50px" }}>Cherry Blossoms Japan <br />24th March - 2nd April 2026</h1>
            <div className="pricing-container">
                <div className="pricing-card early-bird">
                    ...
                    <div className="pricing-validity">last 3 Seats Available</div>
                </div>
...
function ItineraryCard({
    ...
    return (
        <div
            className={`itinerary-card ${index % 2 === 1
                ? 'reverse'
                : ''}`}>
            <div className="itinerary-content">
                <h3>{title}</h3>
                <p
                    className="itinerary-desc"
                    style={{
                        whiteSpace: 'pre-line'
                    }}>{desc}</p>
    ...
    return (
        <section id="itinerary" className="itinerary-section">
            ...
            <div className="itinerary-container">
                {TOUR_DATA
                    .days
                    .map((dayData, index) => (<ItineraryCard key={dayData.day} {...dayData} index={index} />))}
            </div>
        </section>
    );
}
    ...
    return (
        <section id="details" className="details-section">
            ...
            <div className="important-note">
                <strong>💡 Note:</strong>
                Standard check-in time is 15:00 hrs. Early check-in is subject to availability
                and payable directly at the hotel.
            </div>
        </section>
    );
}
...
function Booking() {
    ...
    const PACKAGE_NAME = "Konichiwa Japan 24th - 2nd April 2026";
    const SOURCE_PAGE = "konichiwaa-japan-24th-2nd-april-Page";
...
export function KonichiwaJapan24th2ndApril() {
    return (
        <main>
            <Hero />
            <Pricing />
