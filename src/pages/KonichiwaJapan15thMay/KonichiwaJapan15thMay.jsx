...
import './KonichiwaJapan15thMay.css';
...
function Pricing() {
    return (
        <section className="pricing-section">
            <h1 style={{ textAlign: "center", marginBottom: "50px" }}> Japan  <br />15th May - 24th May 2026</h1>
...
// --- MAIN BODY COMPONENT ---a

export function KonichiwaJapan15thMay() {
    return (
        <main>
            <Hero />
            <Pricing />
